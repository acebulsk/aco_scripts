...
# working directory
setwd("E:/Alex_Working/ACO/Cruickshank/3April_22-23_trip3")
...
raw <- read.csv("Digital_Forms/ACO Ground Truth Plot - ACO Snow Survey Plot (use this one) - v1.88.csv") %>%
  # wrong tare at S1A centre, see notes in orig form.
  mutate(
...
# check number of plots done during trip 3, should be 12
...
write.csv(all_final, "Deliverables/cru_trip3_plots_raw.csv", row.names = F)
